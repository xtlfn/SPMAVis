...
CHARTS = {
    ...
    "chart_rule_heatmap": {
        "renderer": chart_rule_heatmap.render,
        "config_ui": chart_rule_heatmap.render_config_ui,
        "pattern_cat": "rule",
        "fixed_sources": [],
        "accepts_custom_data": True,
    },
    "chart_rule_parallel": {
        "renderer": chart_rule_parallel.render,
        "config_ui": chart_rule_parallel.render_config_ui,
        "pattern_cat": "rule",
        "fixed_sources": [],
        "accepts_custom_data": True,
    },
    "chart_rule_sankey": {
        "renderer": chart_rule_sankey.render,
        "config_ui": chart_rule_sankey.render_config_ui,
        "pattern_cat": "rule",
        "fixed_sources": [],
        "accepts_custom_data": True,
    },
    "chart_rule_list": {
        "renderer": chart_rule_list.render,
        "config_ui": chart_rule_list.render_config_ui,
        "pattern_cat": "rule",
        "fixed_sources": [],
        "accepts_custom_data": True,
    },
